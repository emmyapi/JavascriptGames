...
export class JumpingLeft extends State {
    ...
    handleInput(input){
        if (!this.player.onGround() && this.player.speed < -5 && input === 'PRESS left') this.player.speed += 0;
        else if (!this.player.onGround() && this.player.speed < -5 && input === 'PRESS right') {
            this.player.speed = 5;
            this.player.setState(states.JUMPING_RIGHT);
        }
        if (!this.player.onGround() && this.player.speed > -5 && input === 'PRESS left') this.player.speed = -5;
...
export class JumpingRight extends State {
    ...
    handleInput(input){
        if (!this.player.onGround() && this.player.speed > 5 && input === 'PRESS right') this.player.speed += 0;
        else if (!this.player.onGround() && this.player.speed > 5 && input === 'PRESS left') {
            this.player.speed = -5;
            this.player.setState(states.JUMPING_LEFT);
        }
        if (!this.player.onGround() && this.player.speed < 5 && input === 'PRESS right') this.player.speed = 5;
